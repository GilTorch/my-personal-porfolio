...
export default function Home() {
  ...
  const [contactFormData, setContactFormData] = useState<Email>({
    subject: "",
    message: "",
  });
      ...
      <main className={styles.main}>
        <section ref={bioRef} className={styles.section} id="bio">
          ...
          <div className={styles.bioSectionCol2}>
            <h1>My name is Gilbert Torchon</h1>
            <p className={styles.bioParagraph}>
              I am an experienced Software Developer with a bachelor&apos;s
              degree in Computer Science. With over 4 years of professional
              experience in Web and Mobile Development (mostly React and React
              Native), I have sharpened my skills through boot camps and
              research. After getting my degree, I was certified in Front End
              Development by Freecodecamp which led to my first job as a
              Software Developer. As part of a training program in that job, I
              was certified by Flatiron School as a Full Stack Web Developer.
              Because I did really well during my own training, I was chosen to
              assist my colleagues in their own training. Later on, I
              self-trained in React Native and lead a team into developing a
              social mobile media app for students. Fast-forward to today, I
              joined BairesDev, a nearshore outsourcing company.
            </p>
            <div>
        ...
        <CurvedHR />
        <section
          ref={expertiseAndSkillsRef}
          className={styles.section}
          id="expertise-and-skills"
        >
          <h2>
            Expertise & Skills{" "}
            <span className={` ${styles.hint}`}>
              ({onMobile ? "Click" : "Hover"} on the skill category to see
              skills)
            </span>
          </h2>
        ...
        <section ref={contactRef} className={styles.section} id="contact">
          ...
          <div className={styles.contactCol2}>
            <form onSubmit={onSubmit} className={styles.form}>
              <h3 className={styles.formTitle}>Drop me a Message</h3>
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  onChange={handleChange}
                  placeholder="Hi Gilbert! Let's work together"
                  rows={10}
                  name="message"
                  required
                ></textarea>

        ...
        <section className={styles.section} id="expertise-and-skills">
          ...
          <div className={styles.skillCards}>
            {skills.map((skill,index) => (
              <div style={{opacity: selectedSkill === skill.category ? 0: 1}} onMouseLeave={() => setSelectedSkill(null)} onMouseEnter={() => setSelectedSkill(skill.category)} key={index}  ref={webDevelopmentSkillCardRef} className={styles.skillCard}>
